...
def root():
    return {
        ...
        "endpoints": [
            ...
            "POST /admin/analyze-use-case-samples",
            "POST /admin/datasets/analyze-samples",
            "POST /api/admin/analyze-use-case-samples",
            "POST /api/admin/datasets/analyze-samples",
            "POST /admin/datasets/{id}/samples",
            "POST /api/admin/datasets/{id}/samples",
            "GET /ai-health",
            "GET /api/ai-health",
            "GET /runs/{id}",
            "GET /runs/{id}/diff",
