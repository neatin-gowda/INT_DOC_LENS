...
Builds the semantic document blocks used by the comparison engine:
...
The output is a flat list of Block objects consumed by the diff engine,
query layer, reports, and visual overlays.
"""
...
__all__ = ["extract_blocks", "render_pages", "coverage_pct"]
